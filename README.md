...
What intervention should be attempted?

Is that intervention allowed by policy?

Was the action executed?

Was recovery actually verified?

Should the system retry, stop, or escalate?
...
Revenue, risk and recovery overview

Recovery

/api/recovery

Recovery actions and workflow

Analytics

/api/analytics

Data-driven recovery analytics
